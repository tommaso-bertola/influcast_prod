...
bounds_factory <- function() {
    ...
    bounds <- list()
    bounds <- register_bound(bounds, "log_phi", log(0.000001), log(1))
    bounds <- register_bound(bounds, "mu_inv_1", 0.0005, 70)
    bounds <- register_bound(bounds, "mu_inv_2", 0.0005, 70)
    bounds <- register_bound(bounds, "log_p_rep", log(0.005), log(0.8))
    ...
    bounds <- register_bound(bounds, "q_1", log(0.000001), log(20), 1)
    bounds <- register_bound(bounds, "q_2", log(0.000001), log(20), 1)
    bounds <- register_bound(bounds, "log_prop_rec_12", log(0.000001), log(0.9))
    return(bounds)
}
