...
library(readr)
library(reshape2)
incidence <- function(season = NULL, n_week = NULL, italian_population, reg_pop, signal, consolidate = FALSE, signal_type = "ARI") {
    ...
    df <- influcast_data_acquisitor(n_week, signal, season, signal_type)
